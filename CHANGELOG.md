...
### Changed
- Refactor `KinematicBlinkFeatureExtractor.compute` into dedicated helper stages to reduce nested looping and improve readability/debugging while preserving output behavior.
